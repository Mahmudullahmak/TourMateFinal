...
public class NearbyPlacesActivity extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
        ...
        mService.getNearbyPlaces(url)
                .enqueue(new Callback<MyPlaces>() {
                    ...
                    public void onFailure(Call<MyPlaces> call, Throwable t) {
                        ...
                        Toast.makeText(NearbyPlacesActivity.this, "LocationFailed", Toast.LENGTH_SHORT).show();
                    }
                });
